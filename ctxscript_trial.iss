; Installs Context Scripting Trial Package
...
[Files]
Source: "source\CtxPkg*.pas"; DestDir: "{app}\source"; CopyMode: alwaysoverwrite; Components: sources

Source: "libt\d5\*.*"; DestDir: "{app}\libd5"; CopyMode: alwaysoverwrite; Components: libd5
Source: "source\*.*"; Excludes: "*.pas,*D6.*,*D7.*,*D2005.*"; DestDir: "{app}\libd5"; CopyMode: alwaysoverwrite; Components: libd5

Source: "libt\d6\*.*"; DestDir: "{app}\libd6"; CopyMode: alwaysoverwrite; Components: libd6
Source: "source\*.*"; Excludes: "*.pas,*D5.*,*D7.*,*D2005.*"; DestDir: "{app}\libd6"; CopyMode: alwaysoverwrite; Components: libd6

Source: "libt\d7\*.*"; DestDir: "{app}\libd7"; CopyMode: alwaysoverwrite; Components: libd7
Source: "source\*.*"; Excludes: "*.pas,*D5.*,*D6.*,*D2005.*"; DestDir: "{app}\libd7"; CopyMode: alwaysoverwrite; Components: libd7

Source: "libt\d2005\*.*"; DestDir: "{app}\libd2005"; CopyMode: alwaysoverwrite; Components: libd2005
